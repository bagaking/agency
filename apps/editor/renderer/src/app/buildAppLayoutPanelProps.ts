export function buildAppLayoutPanelProps({
  ...
  const appLayoutExplorerPaneProps = {
    ...
    browserLaneMeta: activeBrowserLane,
    onBrowserLaneMetaChange: handleBrowserLaneMetaChange,
    onBrowserLaneSurfaceStateChange: handleBrowserLaneSurfaceStateChange,
