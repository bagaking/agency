...
export function buildAppLayoutProps({
  ...
  return {
    ...
    onCreateAttachmentCell: handleCreateAttachmentCell,
    ...
    onFocusSessionInUi: focusSessionInUi,
    projectReady,
    projectError,
    projectRoot,
    recentProjects,
    ...
    harnessProvidersDirty,
    codexCliProviderSettings,
    onUpdateCodexCliProvider: updateCodexCliProvider,
    onSaveHarnessProviders: saveMainAgentHarnessSettings,
    onClearHarnessProvidersError: clearHarnessProvidersError,
    appShortcutsScopeDisabled,
    appShortcutsSummary,
    replyQuickPromptsScopeDisabled,
    replyQuickPromptsSummary,
