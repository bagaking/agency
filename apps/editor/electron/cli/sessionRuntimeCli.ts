...
function printUsage() {
  process.stdout.write(
    [
      ...
      '',
      'Usage:',
      '  node .electron-build/cli/sessionRuntimeCli.js --json \'<payload-json>\'',
      '  node .electron-build/cli/sessionRuntimeCli.js --file <payload-json-file>',
      '  echo \'<payload-json>\' | node .electron-build/cli/sessionRuntimeCli.js',
      '',
      'Notes:',
