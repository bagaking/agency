...
function printUsage() {
  process.stdout.write(
    [
      ...
      '',
      'Usage:',
      '  node .electron-build/cli/fileIntentCli.js --mode <user|tool|classify> --json \'<payload-json>\'',
      '  node .electron-build/cli/fileIntentCli.js --mode <user|tool|classify> --file <payload-json-file>',
      '  echo \'<payload-json>\' | node .electron-build/cli/fileIntentCli.js --mode <user|tool|classify>',
      '',
      'Notes:',
