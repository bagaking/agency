...
2) Read only the needed lines:
   - `sh "$BAGAKIT_LIVING_DOCS_SKILL_DIR/scripts/living-docs-memory.sh" get <path> --root . --from <line> --lines <n>`
...
- `python3 "$BAGAKIT_LIVING_DOCS_SKILL_DIR/scripts/living-docs-memory-index.py" index --root .`
